...
function AuthPageContent() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] w-full overflow-hidden bg-background">
      {/* Left Side: Animated Wave Canvas (matching SubMate colors) - Full Screen side */}
      <div className="relative hidden md:block w-1/2 overflow-hidden border-r border-border">
        <DotWaveCanvas />
        <div className="relative z-10 flex h-full flex-col justify-between p-12">
          ...
          <div className="space-y-4">
            <h2 className="max-w-[320px] font-heading text-4xl font-extrabold leading-tight text-white">
      ...
      {/* Right Side: Form - Full Screen side */}
      <div className="relative flex w-full flex-col justify-center items-center px-6 py-12 md:w-1/2">
        <button
          onClick={() => router.push("/")}
        ...
        <div className="w-full max-w-sm">
          ...
          <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <Button type="submit" disabled={loading} className="mt-2 h-11 bg-primary text-primary-foreground hover:bg-primary/95">
